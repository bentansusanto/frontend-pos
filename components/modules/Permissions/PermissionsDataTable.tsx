...
import { useDeletePermissionMutation } from "@/store/services/role.service";
...
export default function PermissionsDataTable({ data }: { data: Permission[] }) {
    ...
    () => [
      {
        accessorKey: "module",
        header: "Module",
        cell: ({ row }) => <Badge variant="outline" className="capitalize">{row.getValue("module")}</Badge>,
      },
      {
        accessorKey: "action",
        header: "Action",
        cell: ({ row }) => <div className="font-mono text-xs">{row.getValue("action")}</div>,
      },
      {
          ...
          return (
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end">
                ...
                <DropdownMenuItem onClick={() => setEditingPermission(row.original)}>
